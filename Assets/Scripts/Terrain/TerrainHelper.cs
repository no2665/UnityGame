...
public class TerrainHelper : MonoBehaviour {
    ...
    // Perlin noise generators, from the LibNoise library
    private Perlin fidgetPerlin = new Perlin( 0.04, 1.0, 0.25, 3, System.DateTime.Now.Millisecond, QualityMode.High );
    private Perlin heightPerlin = new Perlin( 0.08, 3.0, 0.75, 2, System.DateTime.Now.Millisecond + 1, QualityMode.High );
